...
<head>
    ...
    <style>
        /* Imagem de fundo */
        body {
            background-image: url('https://img.freepik.com/vetores-premium/um-padrao-desenhado-a-mao-de-elementos-de-padaria-bretzel-croissant-pao-rosquinha-baguete-vector-doodle-sketch_414360-1926.jpg');
            background-size: cover; /* Faz com que a imagem cubra toda a tela */
            background-position: center; /* Centraliza a imagem */
            background-repeat: no-repeat; /* Impede a repetição da imagem */
            font-family: Arial, sans-serif;
            color: #4A2C2A; /* Cor marrom escuro para todo o texto */
            margin: 0;
            padding: 0;
        ...
        h1 {
            font-size: 3em;
            color: #4A2C2A; /* Texto marrom escuro */
        ...
        label {
            ...
            margin-bottom: 10px;
            font-size: 1.1em;
            color: #4A2C2A; /* Texto marrom escuro para os rótulos */
        }
        ...
        input, select {
            ...
            font-size: 1em;
            color: #4A2C2A; /* Texto marrom escuro nos campos de entrada */
        }
